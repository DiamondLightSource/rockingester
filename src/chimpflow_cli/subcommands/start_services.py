...
from rockingest_cli.subcommands.base import Base
...
services = {
    "rockingest_collector_specification": "collector",
}
...
class StartServices(Base):
    ...
    async def __run_coro(self):
        ...
        # rockingest_multiconf.set_logging_mpqueue(self.__mainiac.mpqueue)
